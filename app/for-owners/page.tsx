...
export const metadata: Metadata = {
  title: 'Разместить жильё на КМВ без комиссии — Курортрум',
  description: 'Сдавайте квартиру или дом посуточно в Кисловодске, Пятигорске, Ессентуках и Железноводске. Прямые заявки от туристов, без комиссии с бронирования. 14 дней бесплатно.',
}
    ...
    <main style={{ fontFamily: 'sans-serif', background: '#f8f7f4', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <nav className="catalog-nav" style={{ background: 'white', borderBottom: '1px solid #f0f0f0', padding: '0 32px', height: '72px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', boxShadow: '0 1px 8px rgba(0,0,0,0.04)', flexShrink: 0 }}>
        ...
        <div className="nav-links-row" style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          ...
          <a className="nav-link" href="/for-owners" style={{ color: '#0F4C5C', fontSize: '14px', textDecoration: 'none', fontWeight: 600 }}>Владельцам</a>
      ...
      <section className="hero-pad" style={{ background: '#0E8E76', color: 'white', padding: '60px 24px', textAlign: 'center' }}>
        <h1 style={{ fontSize: '26px', fontWeight: 600, marginBottom: '12px' }}>Разместите жильё на КМВ</h1>
        <p style={{ color: '#7ee8d0', fontSize: '15px', marginBottom: '8px' }}>Прямые заявки от туристов · Без комиссии с бронирования</p>
        <p style={{ color: '#7ee8d0', fontSize: '14px' }}>14 дней бесплатно — начните прямо сейчас</p>
      </section>
      ...
      <section className="section-pad" style={{ maxWidth: '900px', margin: '0 auto', padding: '48px 24px' }}>
        ...
        <div className="plans-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px' }}>
          <div style={{ background: 'white', border: '1px solid #e5e7eb', borderRadius: '16px', padding: '28px' }}>
            ...
            <div style={{ fontSize: '32px', fontWeight: 700, color: '#1a1a1a', marginBottom: '4px' }}>990 ₽</div>
            ...
            <a href="/auth/register" style={{ display: 'block', background: 'white', border: '1px solid #2BAE8E', color: '#2BAE8E', padding: '12px', borderRadius: '10px', textAlign: 'center', textDecoration: 'none', fontSize: '15px', fontWeight: 500 }}>
              Начать бесплатно
            </a>
          </div>

          <div className="plan-popular" style={{ background: 'white', border: '2px solid #2BAE8E', borderRadius: '16px', padding: '28px', position: 'relative', marginTop: '-8px' }}>
            ...
            <div style={{ fontSize: '32px', fontWeight: 700, color: '#1a1a1a', marginBottom: '4px' }}>1 990 ₽</div>
            <div style={{ fontSize: '13px', color: '#6b7280', marginBottom: '24px' }}>в месяц</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '24px' }}>
            ...
            <a href="/auth/register" style={{ display: 'block', background: '#2BAE8E', color: 'white', padding: '12px', borderRadius: '10px', textAlign: 'center', textDecoration: 'none', fontSize: '15px', fontWeight: 500 }}>
              Начать бесплатно
            </a>
          </div>
          ...
          <div style={{ background: 'white', border: '1px solid #e5e7eb', borderRadius: '16px', padding: '28px' }}>
            ...
            <div style={{ fontSize: '32px', fontWeight: 700, color: '#1a1a1a', marginBottom: '4px' }}>4 990 ₽</div>
            <div style={{ fontSize: '13px', color: '#6b7280', marginBottom: '24px' }}>в месяц</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '24px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            {[
              ...
              <div key={s.n} style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                <div style={{ width: '36px', height: '36px', borderRadius: '50%', background: '#f0fdf9', color: '#2BAE8E', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 600, flexShrink: 0 }}>{s.n}</div>
                <div>
